                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-users"></i><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('login_credential'); ?> <?php echo $this->lang->line('report'); ?></h3>
                        </div>
                           ...
                           <table class="table table-striped table-bordered table-hover student-list" data-export-title="<?php echo $this->lang->line('login_credential'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- class and section is added here extra when asked by client -->
