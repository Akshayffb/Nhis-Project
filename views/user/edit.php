        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url("user/user/edit/") ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
...
<?php } ?>
                                    ...
                                    // echo display_custom_fields('students', );
                                     ...
                                     $custom_fields_col =array(1,3,4,5,6,7,30);
                                        echo display_custom_fields('students',$student['id'],$custom_fields_col);
                                    ?>
                                    </div>
                                </div>
                            </div>
