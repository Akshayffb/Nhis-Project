#views Student Report page code
                            ...
                            <div >
                                <table class="table table-striped table-bordered table-hover student-list" data-export-title="<?php echo $this->lang->line('student') . " " . $this->lang->line('report'); ?>">
                                    <thead>
                                        ...
                                        <?php if ($sch_setting->house_name) { ?>
                                            <th><?php echo $this->lang->line('house_name'); ?></th>
                                        <?php }?>


                                        <th><?php echo $this->lang->line('route_id'); ?></th> 
                                                 <?php if ($sch_setting->route_id) { ?>
                                                     <th><?php echo $this->lang->line('route_id'); ?></th>
                                                 <?php }?>
